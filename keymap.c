...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [ADJUST_LAYER] = LAYOUT_wrapper(
    R1(XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
    R2(XXXXXXX, QWERTY,  KC_MAKE, XXXXXXX, RESET,   KC_TMUX,  XXXXXXX, BTA_USB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
    R3(KC_GBYE, KC_SPOT, XXXXXXX, XXXXXXX, XXXXXXX, GUEST,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
    R4(XXXXXXX, XXXXXXX, XXXXXXX, BTA_CMD, KC_VERS, BTA_BLE,  XXXXXXX, MU_TOG,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
