...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [RAISE_LAYER] = LAYOUT_wrapper(
    R1(XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
    R2(CMD_TAB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_TILD, XXXXXXX, KC_AMPR, KC_ASTR, KC_LCBR, KC_RCBR, KC_GRV)
  ...
  [NAV_LAYER] = LAYOUT_wrapper(
    R1(XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
    R2(APP_TOG, XXXXXXX, XXXXXXX, LCTL_E,  XXXXXXX, XXXXXXX, LCTL_Y,  LCTL_U,  LCTL_I,  LCTL_O,  XXXXXXX, _______)
    R3(_______, EM_TOP,  XXXXXXX, LCTL_D,  LCTL_F,  XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, _______)
