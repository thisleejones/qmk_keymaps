...
/* no-op switching to Bluetooth when not enabled. */
#define OUT_BT KC_NO
#endif
...
#define RC(kc) RCTL(KC_##kc)
#define RS(kc) RSFT(KC_##kc)
#define RA(kc) RALT(KC_##kc)
#define RG(kc) RGUI(KC_##kc)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [ADJUST_LAYER] = LAYOUT_wrapper(
    R1(XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
    R2(XXXXXXX, QWERTY,  KC_MAKE, XXXXXXX, RESET,   KC_TMUX,  XXXXXXX, OUT_USB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
    R3(KC_GBYE, OUT_AUTO,KC_SPOT, XXXXXXX, XXXXXXX, GUEST,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
    R4(XXXXXXX, XXXXXXX, XXXXXXX, KC_CAPS, KC_VERS, OUT_BT,   XXXXXXX, MU_TOG,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX)
